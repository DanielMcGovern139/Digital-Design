...
## Switches
set_property PACKAGE_PIN V17 [get_ports {fxn[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {fxn[0]}]
set_property PACKAGE_PIN V16 [get_ports {fxn[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {fxn[1]}]
set_property PACKAGE_PIN W16 [get_ports {fxn[2]}]					
...
set_property PACKAGE_PIN W13 [get_ports {A[4]}]					
